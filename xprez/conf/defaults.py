    ...
    "section_config": {
        ...
        "padding_left": {
            ...
            "values": {
                ...
                constants.PADDING_SMALL: {0: 16, 1: 32},
                constants.PADDING_MEDIUM: {0: 32, 1: 48},
                constants.PADDING_LARGE: {0: 48, 1: 64},
            },
        },
        "padding_right": {
            "units": "px",
        ...
        "padding_top": {
            "units": {
                ...
                constants.PADDING_SMALL: "px",
                constants.PADDING_MEDIUM: "px",
                constants.PADDING_LARGE: "px",
                constants.PADDING_CUSTOM: "px",
            },
            "values": {
                constants.PADDING_NONE: {0: 0},
                constants.PADDING_SMALL: {0: 16, 4: 32},
                constants.PADDING_MEDIUM: {0: 32, 4: 80},
                constants.PADDING_LARGE: {0: 48, 4: 160},
            },
        },
        "padding_bottom": {
            "units": "px",
            "values": {
                ...
                constants.PADDING_SMALL: {0: 16, 4: 32},
                constants.PADDING_MEDIUM: {0: 32, 4: 80},
                constants.PADDING_LARGE: {0: 48, 2: 64, 4: 160},
            },
        },
        "gap": {
            "units": "px",
