...
**Field renames:**
- `content_type` → `module_type` (in Module only - Container.content_type is kept as Django's content_type pattern)
- `content` → `module` (in ModuleConfig and ModuleItem subclasses)
- `content_centered` → `module_centered` (in CkEditor and GridBoxes)
...
- `xprez/templates/xprez/contents/` → `xprez/templates/xprez/modules/`
- `xprez/templates/xprez/admin/contents/` → `xprez/templates/xprez/admin/modules/`
- `xprez/templates/xprez/admin/content_configs/` → `xprez/templates/xprez/admin/module_configs/`
- `xprez/templates/xprez/admin/icons/contents/` → `xprez/templates/xprez/admin/icons/modules/`
...
- `ContentTypeManager` → `ModuleTypeManager`
...
- `Module.module_type` and `Container.module_type` are now full model class following django convention
