...
- migrations:
   ...
   *add following code:*
    ...
    from xprez.migrations._operations import (
    ...
    class Migration(migrations.Migration):
        ...
        operations = [
            ContentToModule("XprezAnchor"),  # <- add for each non-abstract custom Module
            ContentsContainerToContainer("Page"),  # <- add for each non-abstract custom Container
            MoveModule("test_1.XprezAnchor", "xprez.AnchorModule", ["title", "key"]),  # <- if you had custom XprezAnchor
        ]
    ```
- styles:
